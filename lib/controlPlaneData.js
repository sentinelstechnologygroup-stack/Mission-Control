...
import { buildChatTokenLedger } from './chatTokenLedger.js'
...
export const DEPARTMENTS = [
  ...
  },
  {
    id: 'novella',
    name: 'Novella',
    title: 'Chief Narrative Systems Officer',
    domain: 'Long-form narrative packaging, editorial support, and publication prep',
    mandate: 'Support long-form narrative assembly and editorial packaging for publication-ready work.',
    agents: ['Novella'],
    routeKeywords: ['novella', 'narrative', 'editorial', 'long-form', 'publication', 'story'],
  },
]
...
function buildCosts({ state = {}, workers = [], jobs = [], runtimeDir }) {
  ...
  const chatLedger = buildChatTokenLedger({ runtimeDir, state })
  ...
  return {
    summary: {
      ...
      todayTotalTokenUse: chatLedger.summary.todayTotalTokenUse != null ? formatNumber(chatLedger.summary.todayTotalTokenUse) : (session.tokensUsed != null ? formatNumber(session.tokensUsed) : 'Unavailable'),
      weeklyTokenUse: chatLedger.summary.allTimeEstimatedTokenUse != null ? formatNumber(chatLedger.summary.allTimeEstimatedTokenUse) : 'Unavailable',
    ...
    apiKeyTracking,
    chatUsageSummary: chatLedger.summary,
    chatUsageLedger: chatLedger.rows,
    chatUsageActive: chatLedger.activeRows,
    chatUsageInactive: chatLedger.inactiveRows,
    chatUsageArchived: chatLedger.archivedRows,
    dashboardWarning,
